 ...
 `
  ...
  'InterFatecs': {
    ...
    conteudo: `
       ...
       <p><strong>Participação da FATEC de São José dos Campos na Maratona InterFatecs</strong></p>
       <p>A FATEC de São José dos Campos tem se destacado nas edições da Maratona de Programação InterFatecs, consolidando-se como uma das instituições mais competitivas do Centro Paula Souza. Em 2018, a FATEC SJC participou com destaque, mas não conquistou o 1º lugar na 7ª edição da competição, realizada na FATEC Americana. Em 2022, a FATEC SJC conquistou o 3º lugar na 9ª edição da maratona com a equipe Hadouken Team, composta pelos estudantes Gabriel Giraud, Marcos Toledo e Nicolas Fujisawa. A participação demonstrou a continuidade da excelência da unidade mesmo em meio a um cenário de grande competitividade entre as Fatecs do estado</p>
       <p>O destaque mais recente veio em 2023, quando a equipe Ctrl+Alt+Elite, formada por Camila Redondo, Henrique Ferreira Neto e Willyan Antunes, conquistou o 1º lugar na 11ª edição da Maratona InterFatecs, realizada na FATEC Praia Grande. A vitória reafirmou o alto nível técnico dos alunos da unidade e a competência de seus professores na preparação para desafios em lógica de programação e resolução de problemas.</p>
       <p>Além do bom desempenho nas competições, a FATEC de São José dos Campos também participou ativamente da organização técnica da edição de 2025. Professores como Eduardo Sakaue e Reinaldo Arakaki colaboraram na elaboração das provas, enquanto Fabiano Sabha atuou na infraestrutura digital do evento. A final da edição de 2025 está prevista para ocorrer na FATEC Ferraz de Vasconcelos, e, até o momento, os resultados das equipes ainda não foram divulgados. Essa atuação tanto em campo quanto nos bastidores reforça a relevância da FATEC SJC no cenário acadêmico e tecnológico do estado.</p>
     `
  },

  'API': {
    titulo: 'Projeto API e Feira de Soluções na FATEC São José dos Campos',
    conteudo: `
       <img src="statics/imgs/icones/API.png" alt="BAJA" class="info-image">
      <p>Na FATEC de São José dos Campos, o método de Aprendizagem por Projetos Integrados (API) tem sido uma característica marcante dos cursos de tecnologia, como Análise e Desenvolvimento de Sistemas, Banco de Dados, Desenvolvimento de Software Multiplataforma e Manufatura Avançada. Esse modelo incentiva os alunos a desenvolverem soluções reais, desde a concepção até a implementação, dentro de um contexto acadêmico colaborativo.</p>
      <p>Um exemplo disso é o projeto denominado API‑Projeto Integrador do 1º Semestre – Automatização do GitHub, desenvolvido por um grupo de alunos de ADS da FATEC SJC. O sistema automatiza a clonagem e raspagem de repositórios GitHub, organizando os projetos por curso, semestre, ano e turma, além de gerar automaticamente um índice navegável para o site institucional. O site conta, inclusive, com um manual ilustrado em formato de GIF para facilitar a instalação. Outro projeto interessante, desenvolvido por alunos do 2º semestre do curso de Banco de Dados, recebeu o nome de Avaliador de Soft Skill. A proposta dessa API é permitir que integrantes de grupos avaliem uns aos outros em competências como Proatividade, Autonomia, Colaboração e Entrega de Resultados, automatizando o cálculo de médias e gerando relatórios padronizados para uso docente — tudo isso com base em metodologia ágil, como o SCRUM.</p>
      <p>Além da prática acadêmica, a FATEC SJC promove eventos que mostram esses resultados para a comunidade. A Feira de Soluções, por exemplo, em sua 6ª edição (realizada em dezembro de 2022), reuniu projetos inovadores dos cursos de tecnologia da unidade e abriu as portas dos laboratórios e instalações para o público. O evento gratuito permitiu que alunos apresentassem suas criações para empresários, possíveis parceiros e clientes, evidenciando o aprendizado adquirido ao longo do semestre. Outra oportunidade para apresentar os projetos ocorrida em 2023 foi o Science & Business Connection, promovido no Parque Tecnológico de São José dos Campos. Nesse evento, os alunos expuseram soluções desenvolvidas por meio da metodologia API para públicos do programa Colmeia, que busca aproximar empresas e instituições de ensino. Entre as soluções, destacaram-se sistemas como: um aplicativo para gestão de recebimento de insumos em agroindústria; um aplicativo inteligente para classificação e contagem de grãos de soja; um crawler para pesquisa de processos trabalhistas em diários oficiais; e um sistema para aquisição e monitoramento de dados ambientais.</p>
      <p><strong>Projeto API na FATEC São José dos Campos: Trabalho em Equipe e Conexão com o Mercado</strong></p>
  ...
  'SAE': {
    ...
    conteudo: `
      ...
      <p>O SAE Aerodesign é um programa estudantil internacional promovido pela SAE International, com edições realizadas no Brasil pela SAE Brasil desde 1999. Seu objetivo principal é oferecer a estudantes de engenharia e tecnologia a oportunidade de aplicar conhecimentos teóricos em um desafio prático: projetar, construir e testar aeronaves radiocontroladas capazes de transportar cargas dentro de restrições específicas de regulamento.</p>
      <p>A competição é dividida em três categorias: Regular, Advanced e Micro. Cada uma delas apresenta restrições e objetivos diferentes, mas todas têm em comum a necessidade de aplicar conceitos de aerodinâmica, estruturas, propulsão, eletrônica embarcada, além de habilidades de gestão de projetos e trabalho em equipe. As equipes devem elaborar um relatório técnico detalhado, justificar as escolhas de projeto e, ao final, realizar os voos de demonstração. A avaliação é feita tanto com base nos relatórios técnicos quanto no desempenho prático durante a competição.</p>
      <p> O diferencial do SAE Aerodesign está no seu caráter formativo. Ao longo de meses, os alunos precisam lidar com desafios reais da engenharia, como restrições de peso, otimização estrutural, testes de materiais e simulações de voo. A experiência também envolve forte componente de gestão, já que as equipes precisam buscar patrocínios, administrar recursos financeiros, organizar cronogramas e apresentar seus resultados em inglês para avaliadores da indústria aeronáutica.</p>
      <p>No Brasil, a competição tem relevância especial por ser realizada anualmente na cidade de São José dos Campos, polo da indústria aeroespacial do país, que abriga instituições como Embraer, ITA e DCTA. Desde a sua primeira edição, em 1999, o evento tem caráter contínuo, sendo hoje um dos mais tradicionais programas estudantis do setor aeronáutico no Brasil. Além de estimular a inovação, o SAE Aerodesign funciona como um ponto de encontro entre a academia e a indústria, ajudando a revelar novos talentos para o setor aeroespacial.</p>       
      `
  },
  'HackaTruck': {
  ...
  'benedito': {
    ...
    conteudo: `
       ...
       <p>Na época, a equipe da secretaria era bem menor. Hoje são cinco, mas naquele período começaram com quatro pessoas: Luciana, Átila, Elisângela, Isa e Benedito, com algumas mudanças de pessoal nos primeiros meses. Com o tempo, Hélio entrou para reforçar a equipe, e a operação ganhou mais estabilidade. Quanto aos sistemas acadêmicos, Benedito entrou justamente durante a transição do sistema antigo para o SIGA. O sistema antigo era local e ainda usado em alguns casos, enquanto os novos alunos já utilizavam o SIGA. Por um período, foi necessário lidar com ambos, o que exigia atenção redobrada para emitir documentos e manter os registros atualizados. Essa transição tecnológica, somada à mudança física, representou um grande desafio nos primeiros anos.</p>
...
<p>A rotina na secretaria também traz histórias curiosas. Um dia, uma pessoa passou vestida de unicórnio; em outras ocasiões, mães de alunos aparecem de forma inesperada, ou até animais entram no prédio. São pequenas surpresas do dia a dia que tornam o trabalho mais leve e divertido, mesmo em meio à rotina intensa.</p>
...
`,
  ...
  'marcus': {
    ...
    conteudo: `
      ...
      <p>Marcus se define como joseense de segunda geração. Casado com a historiadora Laura e pai de dois filhos, Samuel e Clarice, ele compartilha suas paixões por automobilismo, kart, café e jogos de computador — hobbies que o ajudam a manter o equilíbrio entre vida pessoal e profissional. Inclusive, chegou a estar entre os 5% melhores jogadores de Counter-Strike do mundo em 2022.</p>
      <p>Ingressou na Fatec com 17 anos, logo após o ensino médio. Inicialmente, pensava em cursar Engenharia de Produção, mas acabou se encantando com a Logística. Apesar de a Fatec ser nova e funcionar ainda nas instalações do Parque Tecnológico, Marcus se sentiu acolhido e viu o curso como uma excelente oportunidade, destacando a proximidade entre alunos e professores como fator essencial em sua decisão.</p>
      <p>Durante a graduação, estagiou no CECOMPI (atual Nexus Hub) e participou ativamente da vida acadêmica e dos eventos da Fatec, como a primeira Semana de Inovação Tecnológica. Também se voluntariou para projetos no Parque Tecnológico, o que ampliou sua visão de futuro e o motivou a seguir carreira acadêmica.</p>
      <p>Foi orientado pelo professor Tozi em seu trabalho de graduação, com quem publicou um artigo na ANPET. Essa experiência o impulsionou a ingressar diretamente no mestrado em Infraestrutura Aeronáutica pelo ITA. Atuou também como consultor na Heineken e Nissan, sempre na área de logística e supply chain.</p>
      <p>Concluiu o mestrado em 1 ano e 8 meses e, em 2014, voltou à Fatec, desta vez como docente, lecionando Gestão de Transporte de Cargas e Roteirização, disciplina que ministra até hoje. Divide seu tempo entre a docência e a atuação como pesquisador colaborador no ITA, desenvolvendo pesquisas aplicadas à infraestrutura civil.</p>
      <p>Hoje, Marcus cursa doutorado no ITA, na área de transporte aéreo, e acompanha de perto a evolução da Fatec e seus projetos de inovação. É entusiasta do modelo de ensino prático e interdisciplinar, e vê iniciativas como a API (Aprendizagem por Projetos Interdisciplinares) como fundamentais na formação moderna dos alunos. Segundo ele, "não dá mais para ensinar apenas de forma tradicional — o aluno precisa estar no centro do processo".</p>
  ...
  'suelena': {
    ...
    conteudo: `
    <img src="../statics/imgs/pessoas/suelena/suelenaImagem.jpeg" alt="Maria Suelena" class="info-image" style="width: 250px; height: 250px; object-fit: contain;">
  ...
  'barbara-yulli': {
    titulo: 'Bárbara Yulli',
    conteudo: `
    <div class="image-container">
      <img src="statics/imgs/pessoas/alunos/barbara-yulli/foto.jpg" alt="Bárbara Yulli" class="profile-image">
    </div>
    <p>Bárbara Yulli é uma aluna dedicada e comprometida com o aprendizado. Sua jornada na Fatec tem sido marcada por esforço e determinação.</p>
    <p>Com uma paixão pela tecnologia, Bárbara tem se destacado em suas atividades acadêmicas e extracurriculares, contribuindo para o ambiente de aprendizado da instituição.</p>
  `
  }
